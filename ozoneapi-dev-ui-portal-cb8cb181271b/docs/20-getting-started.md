...
As defined further in the ROVA Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the ROVA ASPSP .wellknown endpoint (linked below).
