...
Open Banking is a reform, called for by the Competitions & Market Authority (CMA), which mandates ROVA and the eight other largest current account providers (CMA9) to securely share customer account data and initiate payments with registered third party providers (TPPs) provided the customer has given their consent.
...
### How can I access ROVA Read/Write APIs?
...
This will then enable you to access our APIs through the ROVA Developer Portal

### As a Third Party Provider, is there somewhere I can test prototype Open Banking Solutions?
 Yes, ROVA has a test facility [../40-sandbox.md](Sandbox) available through our Developer Portal. This will be made available in March 2019.
...
(1) Make sure you have registered your SSA in ROVA Developer Portal and the subscription of the Accounts Service Provider API and/or Payments Service Provider API is approved by ROVA
